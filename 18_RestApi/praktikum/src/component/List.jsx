...
const List = ({ id, label, value, type, placeholder, onChange, name }) => {
  return (
    <section className="w-full mt-10">
      ...
      {type === "text" && (
        <input
          ...
          onChange={onChange}
          className={`text-black border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500`}
        />
      )}
      {type === "select" && (
        <select
