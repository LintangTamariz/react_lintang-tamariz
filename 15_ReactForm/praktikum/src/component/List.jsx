...
const List = () => {
  ...
  const isProductFreshnessValid = (isProductFreshness) => {

    const allowedValues = ["Brand New", "Second Hand", "Refubhisnes"]
    return allowedValues.includes(productFreshness);
  }
  ...
  const handleSubmit = (e) => {
    ...
    if (!isProductNameValid(formData.name)) {
      Swal.fire({
        icon: "error",
        title: "Oops...",
      ...
      return;
    // } else if (!isProductCategoryValid(formData.category)) {
    //   Swal.fire({
    //     icon: "error",
    //     title: "Oops...",
    //     text: "Please enter a valid product category.",
    //     confirmButtonText: "OK",
    //   });
    //   return;
    } else if (!isProductPriceValid(formData.price)) {
      Swal.fire({
        icon: "error",
        title: "Oops...",
      ...
      return;
    } else if (!isProductFreshnessValid(formData.freshness)) {
      Swal.fire({
        icon: "error",
        title: "Oops...",
        text: "Please select a valid product freshness.",
        confirmButtonText: "OK",
      });
      return;
    }
