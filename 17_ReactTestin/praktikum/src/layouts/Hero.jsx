      ...
      <div className='container mx-auto '>
        <div className='lg:flex items-center h-screen'>
          <div className='lg:w-1/2 p-4'>
            ...
            <button className='text-white p-4 rounded-3xl mt-10 bg-blue-800 hover:bg-blue-700'>Get Started</button>
            <button className='text-white p-4 ml-5 hover:border rounded-3xl'>Watch Video</button>
          </div>
          <div className='lg:w-1/2 p-4'>
            <img
              src={gambar}
